    ...
    <div>
      ...
      <div className="summary-body">
        ...
        <Row justify="space-between">
          ...
          <Col className="summary-value text-success">{`-${numberWithCommas(
            14000
          )} ₫`}</Col>
        </Row>
        <Row justify="space-between">
      ...
      <Row className="order-total">
        ...
        <Col className="order-total__value">
          <div className="order-total__total">{`${numberWithCommas(getTotalMoney())} ₫`}</div>
          <div className="order-total__additional-text">
            (Đã bao gồm VAT nếu có)
          </div>
        </Col>
      </Row>
      <button type="button" className="btn btn-payment" onClick={action}>
        Thanh toán
      </button>
    </div>
  );
